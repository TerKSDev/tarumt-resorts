...
export default function TopBar({ title, desc, setMenuOpen }: TopBarProps) {
  return (
    <header className="sticky top-0 right-0 bg-white left-0 justify-between items-center flex pl-4 lg:pl-8 pr-4 py-3 border-b border-surface-300">
      ...
      <div className="md:flex items-center gap-4 hidden">
        <div className="flex h-10 gap-3 group focus-within:border-brand-600 focus-within:shadow-md focus-within:ring-1 focus-within:ring-brand-600/20 focus-within:scale-105 transition-all duration-300 border px-4 border-surface-400 p-2 items-center rounded-xl bg-surface-100 focus-within:bg-surface-50 shadow-xs w-72">
          ...
          <input
            id="search"
            className="h-full w-full outline-none text-sm text-surface-800 placeholder:text-surface-500 "
