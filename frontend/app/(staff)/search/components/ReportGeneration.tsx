...
export default function ReportGeneration() {
  ...
  const searchReports = REPORT.filter((f) => f.from === "Guest Search");

  return (
    <Card>
      <CardHeader
        title="Folio Statement & Invoice Export"
        subtitle="Generate printable guest invoices, receipt vouchers, and registration certificates."
