  ...
  return (
    <div className="flex flex-col rounded-xl gap-5 border p-4 md:p-6 border-surface-400 bg-surface-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <label
          htmlFor="bills"
          className={`flex flex-col justify-start shadow-xs p-5 border gap-1 transition-all duration-300 cursor-pointer rounded-xl tracking-wide  hover:-translate-y-0.5 ${report === "bills" ? "border-brand-600 ring-1 ring-brand-600/20 bg-brand-50" : "hover:shadow-sm border-surface-400 bg-surface-100 hover:border-surface-500"}`}
        >
          <input
            type="radio"
            id="bills"
